 ...
 *
 *  Obs:
 *      Para que o Boot Loader carregue conteúdo de um hd SATA é necessário 
 * sondar os disposivos PCI e encontrar a controladora SATA para isso.
 * Também é interessante a posssibilidade de carregar arquivos de 
 * um dispositivo USB ou SD card.
 *
