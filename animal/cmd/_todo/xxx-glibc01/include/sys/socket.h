...
extern int connect (int fd, sockaddr_in *addr, socklen_t len);
extern int send (int fd, char *msg, size_t size, int flags);
extern int recv (int fd, char *msg, size_t size, int flags);
extern int bind (int fd, sockaddr_in *addr, socklen_t len);
extern int listen (int fd, int backlog);
extern int accept (int fd, sockaddr_in *addr, socklen_t *addrlen);
