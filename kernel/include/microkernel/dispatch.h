...
//
//
#define DISPATCHER_PRIORITY_LOW      PRIORITY_LOW         // 1
#define DISPATCHER_PRIORITY_NORMAL   PRIORITY_NORMAL      // 5
#define DISPATCHER_PRIORITY_BOOST    PRIORITY_BOOST       // 7
#define DISPATCHER_PRIORITY_HIGH     PRIORITY_HIGH        // 8
#define DISPATCHER_PRIORITY_REALTIME PRIORITY_REALTIME    // 9
#define DISPATCHER_PRIORITY_MAX      KERNEL_MAX_PRIORITY  //10 
