...
echo -{ ...
echo -{ Compiling ...
	gcc  -c  c:\gramado\desktop\tests\operators\main.c -I c:\gramado\include\libc  -o main.o  
...
echo -{ Linking objects ... 
   ...
   ld -T  c:\gramado\desktop\tests\operators\link.ld -o OPER1.BIN %myObjects%  -Map c:\gramado\desktop\tests\operators\map.s
