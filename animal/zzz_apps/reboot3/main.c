                   ...
                   unsigned long long2 )
{
	...
	switch (msg)
	{
        ...
        case MSG_CREATE:
           ...
           ____this_tty_id = (int) gws_system_call ( 266, getpid(), 0, 0 );        

           write ( ____this_tty_id, __wbuf2, __w_size2 = sprintf (__wbuf2,"writting from reboot3 ...\n") );    
		...
		case MSG_SYSKEYDOWN:
			...
			{  
				case VK_F1:
	                    ...
	                    gws_system_call ( 9800,   //serviço. seleciona o diálogo 
		    ...
		    switch(long1)
		    {
                ...
                case 1:
                    if (window == main_window)
                    {
                        ...
                        //gws_system_call (279, (unsigned long) window, 0, 0 );
...
//#endif
	...
	//++
    //gde_begin_paint ();
    hWindow = (void *) gws_create_window ( WT_OVERLAPPED, 1, 1, 
                           "Reboot2",
    ...
    */
	...
	//++
    //gde_enter_critical_section (); 
    reboot_button = (void *) gws_create_window ( WT_BUTTON, 1, 1, 
                                " Reboot ",  
                                (width/3), ((height/4)*2), 
                                (width/3), (height/8),   
                                hWindow, 0, 
	...
	//++
    //gde_enter_critical_section (); 
    __icon1 = (void *) gws_create_window ( WT_ICON, 1, 1, " Icon ",  
                           (100), (100), 
                           (100), (100),   
