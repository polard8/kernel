 ...
 *fill*         0x00022482        0x2 00
 ...
 .text          0x000243a4      0x990 fs.o
                0x00024430                fs_get_fat_entry
                0x000246a8                fsSearchFile
                0x00024d07                fsInitFat
                ...
                0x0002479a                fs_load_rootdirEx
                0x0002442b                fs_test_fat_vector
                0x00024b95                fsCreateFile
                0x00024d0c                fsInitStructures
                0x00024d11                fsInit
                0x000247eb                fs_load_fatEx
                0x00024403                fs_format
                0x000244d5                fsLoadFile
                0x00024787                fsSearchFileName
                0x000244a3                fs_set_entry_status
                0x00024c9a                fsCheckFat
                ...
                0x000249d4                fsSaveFile
                0x00024467                fs_check_cluster
                0x00024476                fs_load_dir
                0x0002447b                fs_save_dir
                0x0002483a                fs_put_list_on_fat
                0x00024c8d                fsClearFat
                0x00024494                fs_init_bootfile_struct
                0x000243c7                fatLoadCluster
                0x000248ed                fs_find_n_empty_entries
                0x0002445d                fs_show_dir_entry
                0x0002444e                fs_set_structures
                0x0002443f                fsCreateFileName
                0x00024973                fs_load_rootdir
                0x000244c1                fs_install
                0x00024b7b                fsCreateDir
                0x000249aa                write_lba
                0x000243a4                fatClustToSect
 .text          0x00024d34      0x640 shell.o
                0x00024d9c                shellProcedure
                0x00024d34                shellMain
                0x0002529a                boot
                0x00025345                shellInit
                0x00024e9e                shellWaitCmd
                0x0002529f                debug
                0x00024eb6                shellCompare
                0x000252b8                testa_mbr
                0x00024e1e                shellInitializePrompt
                0x000252f8                testa_root
                0x00025338                reboot
                0x00025286                shellHelp
 .text          0x00025374       0x10 services.o
                0x0002537e                system_services
                0x00025374                blServices
 .text          0x00025384       0x20 abort.o
                0x00025384                abort
 .text          0x000253a4      0x100 faults.o
                0x00025493                mostra_reg
                0x000253a4                cpu_falts
                0x00026000                . = ALIGN (0x1000)
 *fill*         0x000254a4      0xb5c 00
