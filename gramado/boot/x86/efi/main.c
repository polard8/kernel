...
efi_main (EFI_HANDLE image_handle, EFI_SYSTEM_TABLE *systab)
{
	...
	Print(L"efi_main: Gramado Operating System\n");		
	Print(L"#todo: We are working on initialization via UEFI\n");
	Print(L"Please turn off this feature for now and try MBR.\n");
