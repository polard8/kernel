...
//++
//===================
// Isso vai ler no buffer da stream que est� em ring3.
size_t fread (void *ptr, size_t size, size_t n, FILE *fp);
// Isso vai escrever no buffer da stream que est� em ring3.
size_t fwrite (const void *ptr, size_t size, size_t n, FILE *fp);
// Isso vai ler no arquivo que est� em ring0.
int linux_fgetc (FILE *f);
// Isso vai escrever no arquivo que est� em ring0.
