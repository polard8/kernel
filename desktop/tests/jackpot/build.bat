...
echo -{ Compiling ...
	...
	gcc  -c c:\gramado\desktop\tests\jackpot\main.c -I c:\gramado\include\libc -o main.o  
...
echo -{ Linking objects ... 
   ...
   ld -T c:\gramado\desktop\tests\jackpot\link.ld -o JACKPOT.BIN %myObjects% -Map c:\gramado\desktop\tests\jackpot\map.s
