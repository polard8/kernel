...
#define SMALLSYSTEM_GRAMADOCORE_INIT_HEAP_START     (0x01000000 + 0x400000) 
#define SMALLSYSTEM_GRAMADOCORE_SHELL_HEAP_START    (0x01000000 + 0x800000) 
#define SMALLSYSTEM_GRAMADOCORE_TASKMAN_HEAP_START  (0x01000000 + 0xC00000) 
//...
