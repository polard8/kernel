...
==============================
    ...
    /sm  *  é a interface de administração do sistema,
...
por utilitários do sistema em user mode que desejam configurara o sistema. 
Obs: Os utilitários utilizarão rotinas mais complexas e maiores que essas. Essas rotinas aqui serão as primitivas usadas por eles.
