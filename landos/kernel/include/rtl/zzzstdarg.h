...
// operacional Gramado, na arquitetura x86_64.
// Fred Nora
 ...
 * Amount of space required in an argument list (ie. the stack) 
 * for an argument of type t. 
 */

#define __va_argsiz(t) \
    (((sizeof(t) + sizeof(long) - 1) / sizeof(long)) * sizeof(long))
