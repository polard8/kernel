    ...
    switch (msg)
    {
		...
		case MSG_SYSKEYDOWN:
		    switch(long1)
			{
				...
				case VK_F1:
					...
					gde_message_box ( 3, 
					    "Gramado Core - Shell Topbar","F1: HELP");
					break;
		...
		case MSG_SYSKEYUP:
            switch(long1){
				...
				case VK_APPS:
				    gde_message_box ( 3, 
				        "Gramado Core Shell Topbar:","Context Menu");
					break;
			}		
		    break;
		...
		case MSG_COMMAND:
            switch(long1)
			{
				...
				case CMD_ABOUT:
				    // Test.
				    gde_message_box ( 3, 
				        "Shell test Topbar","Testing MSG_COMMAND.CMD_ABOUT.");
				    break;
...
void terminalCreateWindow (void){
	...
	hWindow = (void *) gde_create_window ( WT_OVERLAPPED, 1, VIEW_NORMAL, "XXX",     
                                40, 40, 400, 400,
...
/*
	...
	taskbar_window = (void *) gde_create_window ( WT_SIMPLE, 1, 1, "Taskbar",     
	...
	if ( (void *) taskbar_window == NULL )
	{
	 ...
	 gde_register_window (taskbar_window);
	 gde_show_window (taskbar_window);
	
    //em shell.h está o ponteiro.	
	taskbar_button1 = (void *) gde_create_window ( WT_BUTTON, 1, 1, " Menu ",     
    ...
    gde_register_window (taskbar_button1);
	gde_show_window (taskbar_button1);
...
int terminalTestButtons (void){
    ...
    //em shell.h está o ponteiro.	
	app1_button = (void *) gde_create_window ( WT_BUTTON, 1, 1, "1",     
    ...
    //em shell.h está o ponteiro.	
	app2_button = (void *) gde_create_window ( WT_BUTTON, 1, 1, "2",     
    ...
    //em shell.h está o ponteiro.	
	app3_button = (void *) gde_create_window ( WT_BUTTON, 1, 1, "3",     
    ...
    //em shell.h está o ponteiro.	
	app4_button = (void *) gde_create_window ( WT_BUTTON, 1, 1, "4",     
