...
echo -{ head
	...
	rem head.s
	nasm c:\gramado\cmd\tctype\head.s -felf -o head.o
...
echo -{ app1 (init task)
	...
	gcc  -c c:\gramado\cmd\tctype\main.c -I c:\gramado\include\libc -o main.o  
...
echo -{ Linking objects ... 
   ld -T  c:\gramado\cmd\tctype\link.ld -o TCTYPE.BIN %myObjects%  -Map   c:\gramado\cmd\tctype\map.s
