...
echo -{ Creating head.o ...
	...
	nasm  c:\gramado\apps\shell\head.s  -felf -o head.o
    rem essa deveria ser crt0.s ? (C RunTime)
	
echo -{ Creating main.o ...
    rem crt0.o não deve ser compilado aqui ... isso é só um teste.
    gcc -c c:\gramado\apps\shell\crt0.c     -I c:\gramado\include\libc  -o crt0.o 	
	gcc -c c:\gramado\apps\shell\main.c     -I c:\gramado\include\libc  -o main.o 
    gcc -c c:\gramado\apps\shell\shellui.c  -I c:\gramado\include\libc  -o shellui.o
    gcc -c c:\gramado\apps\shell\builtins.c -I c:\gramado\include\libc  -o builtins.o	
	gcc -c c:\gramado\apps\shell\desktop.c  -I c:\gramado\include\libc  -o desktop.o
...
echo -{ ...
echo -{ Linking ... 
   ld -T c:\gramado\apps\shell\link.ld -o SHELL.BIN %myObjects% -Map shell_map.s
