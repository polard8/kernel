...
echo -{ head
	...
	rem head.s
	nasm c:\gramado\desktop\tests\miniyacc\head.s -felf -o head.o
...
echo -{ app1 (init task)
	...
	gcc  -c c:\gramado\desktop\tests\miniyacc\main.c -I c:\gramado\include\libc -o main.o  
...
echo -{ Linking objects ... 
   ld -T  c:\gramado\desktop\tests\miniyacc\link.ld -o MINIYACC.BIN %myObjects%  -Map   c:\gramado\desktop\tests\miniyacc\map.s
