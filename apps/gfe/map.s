 ...
 *(.bss)
 ...
 .bss           0x00412060     0x8010 api.o
 .bss           0x0041a070       0x30 status.o
 .bss           0x0041a0a0       0x30 addrbar.o
                0x0041b000                . = ALIGN (0x1000)
 *fill*         0x0041a0d0      0xf30 00
 COMMON         0x0041b000      0xe10 main.o
                0x0041b000                prompt
                ...
                0x0041b460                stdin
                0x0041b470                rect
                0x0041b480                prompt_max
                0x0041b490                TOPBAR
                0x0041b4b0                CurrentWindow
                0x0041b4c0                prompt_err
                0x0041b8c0                current_semaphore
                0x0041b8d0                g_columns
                0x0041b8e0                stdout
                0x0041b8f0                Streams
                0x0041b970                g_rows
                0x0041b980                prompt_out
                0x0041bd80                g_cursor_y
                0x0041bd90                gWindow
                0x0041bda0                CursorInfo
                0x0041bdb0                STATUSBAR
                0x0041bdd0                prompt_status
                0x0041bde0                g_char_attrib
                0x0041bdf0                ApplicationInfo
                0x0041be00                g_cursor_x
 COMMON         0x0041be10      0x900 stdlib.o
                0x0041be10                current_mmblock
                0x0041be20                mm_prev_pointer
                0x0041be30                heap_end
                0x0041be40                g_available_heap
                0x0041be50                heap_start
                0x0041be60                heapCount
                0x0041be70                HEAP_START
                0x0041be80                g_heap_pointer
                0x0041be90                heapList
                0x0041c290                randseed
                0x0041c2a0                HEAP_SIZE
                0x0041c2b0                last_size
                0x0041c2c0                last_valid
                0x0041c2d0                mmblockList
                0x0041c6d0                libcHeap
                0x0041c6e0                Heap
                0x0041c6f0                mmblockCount
                0x0041c700                HEAP_END
 COMMON         0x0041c710       0x40 api.o
                0x0041c710                messagebox_button2
                0x0041c720                dialogbox_button1
                0x0041c730                messagebox_button1
                0x0041c740                dialogbox_button2
                0x0041c750                end = .
                0x0041c750                _end = .
                0x0041c750                __end = .
LOAD crt0.o
