...
echo -{ ...
echo -{ Compiling ...
	gcc  -c  c:\gramado\cmd\operators\main.c -I c:\gramado\include\libc  -o main.o  
...
echo -{ Linking objects ... 
   ...
   ld -T  c:\gramado\cmd\operators\link.ld -o OPER1.BIN %myObjects%  -Map c:\gramado\cmd\operators\map.s
