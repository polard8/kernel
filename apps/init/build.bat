...
echo -{ head
    rem head.s
	nasm c:\gramado\apps\init\head.s -felf -o head.o

	
:Compiling	
echo -{ ...
echo -{ main
	gcc  -c  c:\gramado\apps\init\main.c  -I c:\gramado\include\libc -o main.o  
...
echo -{ Linking objects ... 
   ld -T c:\gramado\apps\init\link.ld -o INIT.BIN %myObjects%  -Map  init_map.s
