...
void set_up_cursor ( unsigned long x, unsigned long y )
{
    ...
    vc_cons[fg_console].tty->cursor_x = (unsigned long) x;
    vc_cons[fg_console].tty->cursor_y = (unsigned long) y;
}
...
{
    return (unsigned long) vc_cons[fg_console].tty->cursor_x;
}
...
{
    return (unsigned long) vc_cons[fg_console].tty->cursor_y; 
}
...
unsigned long systemGetSystemMetrics ( int index )
{
    ...
    switch ( index ){
        ...
        case 3:
            return (unsigned long) vc_cons[fg_console].tty->cursor_width_in_pixels;
            break;

        //cursor height in pixels.
        case 4:
            return (unsigned long) vc_cons[fg_console].tty->cursor_height_in_pixels;
            break;
