...
echo -{ head
	...
	rem head.s
	nasm c:\gramado\cmd\tbst2\head.s -felf -o head.o
...
echo -{ app1 (init task)
	...
	gcc  -c c:\gramado\cmd\tbst2\main.c -I c:\gramado\include\libc -o main.o  
...
echo -{ Linking objects ... 
   ld -T  c:\gramado\cmd\tbst2\link.ld -o TBST2.BIN %myObjects%  -Map   c:\gramado\cmd\tbst2\map.s
