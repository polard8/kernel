...
echo -{ ...
echo -{ Compiling ...
	gcc  -c  c:\gramado\cmd\longest1\main.c -I c:\gramado\include\libc -o main.o 
...
echo -{ Linking objects ... 
   ld -T c:\gramado\cmd\longest1\link.ld -o LONGEST1.BIN %myObjects% -Map c:\gramado\cmd\longest1\map.s
