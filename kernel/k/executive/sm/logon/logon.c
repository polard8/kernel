	...
	*/
	...
	if( (void*) CurrentUser != NULL ){
		...
		{		
			...
			draw_text(gui->main, 8*12, 8*5, COLOR_WHITE, "Welcome, press F1=START or F2=REBOOT!");			
			draw_text(gui->main, 8*12, 8*6, COLOR_WHITE, "Copyright (c) 2005-2016, Fred Nora (Under construction!)");
