...
;.getResponse:
	...
	; Obs:
	; A rotina _BlMain configurou os diret�rios e as pagetables.
	; Configurou 4 diret�rios e algumas pagetables.
	; Agora registramos o diret�rio do processo kernel em cr3.
	; Colocando no CR3 o endere�o do diret�rio de p�ginas que o Kernel usar�.


setupCR3:

	; @todo: 
	; Usar vari�vel global.
	; Obs:  
...
setupCR0:
	...
	; contendo vari�veis e m�todos.
	;     O principal m�todo � se passar � _blServices contendo o m�todo
	; que o Boot Loader usa para oferecer servi�os. Desse m�do o Boot Loader
	; pode atuar como um m�dulo do kernel em kernel mode. Outro m�todo
	; que o Boot Loader deve passar para o kernel base � o m�todo _bmServices
...
StartKernelEntry:
   ...
   ;; 36 - cylinders
	...
	; Argumentos passandos atrav�s dos registradores:
	; al = Flag.
	; ebx = LFB address.
	; ecx = BootBlock.
	; edx = BootBlock.
...
blShellLoop:
	...
	;Aqui est� aberta a op��o de chamar o shell do boot loader.
	;call _shell_main	
