...
// para pegarmos alguma informações sobre a janela
 ...
 *  Obs: 
 * Aqui em user mode talvez não precise criar a estrtutura inteira 
 * somente o handle.
 */ 
...
// #todo
// Maybe we need to include a file for this. maybe 'bmp.h'
