...
// dcrt0.c
// The crt0 for Gramado OS ring 3 drivers.
// #atention:
// At the normal case, the initialization drop the iopl to 0,
// calling the kernel for that. But in this case we're gonna
// still use the iopl 3. This way this application can use some
// low level structions, just like 'in', 'out', 'cli', 'sti' ...
//
