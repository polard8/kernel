...
rem
rem
rem Obs: Um benefício imediato dessa nova organização é
rem      trabalhar imediatamente nas partes desbloqueadas
rem      deixando as partes bloqueadas para depois.
rem
...
echo -{ /executive (parte3)
	...
	rem sm
	rem /executive/logon
    gcc -c k/executive/sm/logon/logon.c  -I./include -o logon.o 	
	rem /executive/logoff
    gcc -c k/executive/sm/logoff/logoff.c  -I./include -o logoff.o 	
	...
	rem uigm
	rem /executive/uigm/gui
    rem char
    gcc -c k/executive/uigm/gui/char.c  -I./include -o char.o
    rem pixel
    gcc -c k/executive/uigm/gui/pixel.c  -I./include -o pixel.o 
    rem line
    gcc -c k/executive/uigm/gui/line.c   -I./include -o line.o	
    rem rect
    gcc -c k/executive/uigm/gui/rect.c   -I./include -o rect.o 
    rem draw
    gcc -c k/executive/uigm/gui/dtext.c  -I./include -o dtext.o
    rem draw
    gcc -c k/executive/uigm/gui/draw.c   -I./include -o draw.o	
    rem createw
    gcc -c k/executive/uigm/gui/createw.c  -I./include -o createw.o    
    rem grid
    gcc -c k/executive/uigm/gui/grid.c  -I./include -o grid.o 
    rem statusbar
    gcc -c k/executive/uigm/gui/statusbar.c  -I./include -o statusbar.o 
    rem menubar
    gcc -c k/executive/uigm/gui/menubar.c    -I./include -o menubar.o 
    rem menu
    gcc -c k/executive/uigm/gui/menu.c     -I./include -o menu.o 
    rem bmp
    gcc -c k/executive/uigm/gui/bmp.c     -I./include -o bmp.o 
    rem button
    gcc -c k/executive/uigm/gui/button.c     -I./include -o button.o 
    rem messagebox
    gcc -c k/executive/uigm/gui/messagebox.c     -I./include -o messagebox.o
    rem dialogboxbox
    gcc -c k/executive/uigm/gui/dialogbox.c     -I./include -o dialogbox.o
	rem background
    gcc -c k/executive/uigm/gui/background.c  -I./include -o background.o  
    rem window
    gcc -c k/executive/uigm/gui/window.c    -I./include -o window.o    
    rem desktop
    gcc -c k/executive/uigm/gui/desktop.c   -I./include -o desktop.o  
    rem window station
    gcc -c k/executive/uigm/gui/wstation.c  -I./include -o wstation.o    
    rem user section
    gcc -c k/executive/uigm/gui/usession.c  -I./include -o usession.o        
	rem gui
    gcc -c k/executive/uigm/gui/gui.c  -I./include -o gui.o    	
    
	rem sm
	gcc -c k/executive/sm/user/userenv.c -I./include -o userenv.o 
