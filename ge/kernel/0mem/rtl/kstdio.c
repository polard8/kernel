...
int stdioInitialize (void){
    ...
    for (i=0; i<4; i++){
        ...
        vc_cons[fg_console].tty->cursor_left = 0; 
        vc_cons[fg_console].tty->cursor_top = 0;  
        vc_cons[fg_console].tty->cursor_right  = (SavedX/cWidth); 
        vc_cons[fg_console].tty->cursor_bottom = (SavedY/cHeight); 
