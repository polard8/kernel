;;
;; Gramado ISO - Esse é o arquivo principal de um ISO que será montado em 
;; assembly usando nasm. 
;; (c) Copyright 2017 - Fred Nora.
;;
;; >>>>> #todo: redefiniremos muitos elementos desse arquivo para refletir o sistema de arquivos.
;;
;; File: main.asm 
;;
;; Descrição:
...
Volume_descriptor:
   ...
   db IS09660_VDT_BOOTRECORD  ;Zero indicates a boot record.
   db 'CD001'                 ;Always "CD001".
   db 0x01                    ;Volume Descriptor Version (0x01).
    ...
    ;ID of the system which can act on and boot the system from the boot record.
        db 'EL TORITO SPECIFICATION         ' 
   
    ;string 32bytes
	;Boot Identifier
    ;Identification of the boot system defined in the rest of this descriptor.
        db '                                ' 
